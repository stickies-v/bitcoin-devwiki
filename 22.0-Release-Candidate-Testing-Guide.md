...
If you want to use a binary, make sure to grab the correct one for your system. There are individual binaries for [macOS](https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/bitcoin-22.0rc3-osx64.tar.gz), [Linux](https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/bitcoin-22.0rc3-x86_64-linux-gnu.tar.gz), [Arm (64 bit)](https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/bitcoin-22.0rc3-aarch64-linux-gnu.tar.gz), [Arm (32 bit)](https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/bitcoin-22.0rc3-arm-linux-gnueabihf.tar.gz), and [RISC-V](https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/bitcoin-22.0rc3-riscv64-linux-gnu.tar.gz). For a full list, checkout [https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/](https://bitcoincore.org/bin/bitcoin-core-22.0/test.rc3/)
