...
## Test RPC `scanblocks` [#23549](https://github.com/bitcoin/bitcoin/pull/23549) and fast wallet rescan [#25957](https://github.com/bitcoin/bitcoin/pull/25957) with blockfiltering enabled node `-blockfilterindex=1`.
