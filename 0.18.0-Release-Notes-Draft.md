...
- #15750 [rpc] Remove the addresses field from the getaddressinfo return object (jnewbery)
...
- #15792 doc: describe onlynet option in doc/tor.md (jonatack)
- #15802 doc: mention creating application support bitcoin folder on OSX (JimmyMow)
