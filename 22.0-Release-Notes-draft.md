...
- Taproot descriptors (for signet and regtest, not mainnet) can be imported into the wallet only after activation has occurred on the network in use. See [descriptors.md](https://github.com/bitcoin/bitcoin/blob/22.x/doc/descriptors.md) for supported descriptors.
