...
- `getpeerinfo` now includes a `mapped_as` field to indicate the mapped Autonomous System for diversifying peer selection. See the `-asmap` configuration option in _New Settings_ below.
