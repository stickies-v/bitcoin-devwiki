...
* [#20197](https://github.com/bitcoin/bitcoin/pull/20197) Protect onion peers in `AttemptToEvictConnection` + refactor and add unit tests (has ACKs by vasild and sipa, Concept ACKs/feedback by sdaftuar, gmaxwell, practicalswift)
