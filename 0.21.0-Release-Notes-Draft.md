...
treat this release (or 0.19.2 / 0.20.2) the same as you would a future release
with Taproot included. While there is no telemetry included in the software,
general network-wide upgrade speed metrics may be used to help inform how
quickly the community can be expected to upgrade. If you don't care about
Taproot, you can still upgrade at will without affecting this. (If you
actively oppose Taproot, please post your reasoning to the development
