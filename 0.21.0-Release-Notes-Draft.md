...
- The `-blocksonly` activation now completely disables fee estimation. (#18766)
...
- #18612 script: Remove undocumented and unused operator+ (MarcoFalke)
- #18732 script: Remove unused, undocumented and misleading `CScript.__add__` (MarcoFalke)
