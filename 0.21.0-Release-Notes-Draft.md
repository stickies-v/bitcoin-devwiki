...
In the interest in gauging how fast it may be safe to deploy Taproot, please
treat this release the same as you would a future release with Taproot
included. There are no telemetry included, but general network-wide adoption
might be used to help inform how quickly the community upgrades. If you don't
care about Taproot, you can still upgrade at will without affecting this. (If
you actively oppose Taproot, please post your reasoning to the development
mailing list at bitcoin-dev@lists.linuxfoundation.org.)
...
- [@sipa comment: we should probably mention BIP155 and BIP157 support here]
...
- [@sipa comment: mention anchoring of block-relay-only connetions?]
