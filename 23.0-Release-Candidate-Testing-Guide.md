...
This document outlines some of the upcoming Bitcoin Core 23.0 release changes and provides steps to help. This is meant to get you started on testing, but is in no way comprehensive! After running through the steps in this guide, you are _encouraged_ to do your own testing.
...
1. starts bitcoind from a fresh datadir, and includes net debug logging so our logs include connection attempts
