...
Full support for native witness addresses (BIP173 / Bech32) has now been added. 
...
full BIP159 support in later versions. This does not yet include support for connecting to these pruned peers.
...
GUI changes
-----------
- Uses of "µBTC" in the GUI now use the more colloquial term "bits", specified in BIP176.
