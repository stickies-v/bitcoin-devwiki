...
Upgrading from versions older than 0.8.0 is no longer supported. If you are
upgrading from an older version, please upgrade to 0.14.x first, then upgrade
to 0.15.0 when that has completed. [sipa: Don't we support upgrading from 0.7 anymore? I don't think that code was removed]
