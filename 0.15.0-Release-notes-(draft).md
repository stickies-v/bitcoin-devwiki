...
The `estimatesmartfee` RPC interface has changed (See [PR 10707][https://github.com/bitcoin/bitcoin/pull/10707]):
...
- `estimaterawfee` returns raw fee data so that customized logic can be implemented to analyze the data and calculate estimates (See [PR 10199][https://github.com/bitcoin/bitcoin/pull/10199]).
