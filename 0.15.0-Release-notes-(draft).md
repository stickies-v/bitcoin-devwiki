...
- Earlier versions experienced a peak in memory usage while flushing UTXO updates to disk.
  As a result, half of the available memory was not actually used as cache, and instead
