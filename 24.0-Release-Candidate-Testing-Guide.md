...
**Current Release Candidate:** [Bitcoin Core 24.0rc3][source-code] ([release-notes][release notes])
...
[source-code]: https://github.com/bitcoin/bitcoin/releases/tag/v24.0rc3
[binaries]: https://bitcoincore.org/bin/bitcoin-core-24.0/test.rc3/
...
2. Which release candidate you tested and whether you compiled from source or used a binary (e.g. 24.0rc3 binary or 24.0rc3 compiled from source)
3. What you tested
