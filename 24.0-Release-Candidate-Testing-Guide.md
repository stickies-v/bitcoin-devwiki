...
> :bulb: Instead of scanning through the lengthy response of `getpeersinfo` in order to confirm your address for each outgoing connection, you can **use some `jq` magic to easily filter the relevant field and get a simplified view**: 
> ```shell
