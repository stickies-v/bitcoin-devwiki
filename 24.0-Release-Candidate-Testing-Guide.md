...
**Current Release Candidate:** [Bitcoin Core 24.0rc2][source-code] ([release-notes][release notes])
...
[source-code]: https://github.com/bitcoin/bitcoin/releases/tag/v24.0rc2
[binaries]: https://bitcoincore.org/bin/bitcoin-core-24.0/test.rc2/
...
For the downloaded binary, start from the root of the downloaded release candidate (cd ~/bitcoin-24.0rc2, for example) and run:
```shell
...
2. Which release candidate you tested and whether you compiled from source or used a binary (e.g. 24.0rc2 binary or 24.0rc2 compiled from source)
3. What you tested
