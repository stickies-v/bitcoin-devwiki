...
**Current Release Candidate:** [Bitcoin Core 23.0rc1][source-code] ([release-notes][release notes])
...
If you want to use a binary, make sure to grab the correct one for your system. [NA]
...
> :bulb: Use `grep` to easily filter the response of the RPC e.g. `cli getpeerinfo | grep "presynced_headers"`
