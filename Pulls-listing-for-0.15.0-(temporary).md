This is temporary on the wiki, and will be added to the 0.15.0 release notes before final is tagged.
feel free to move things to the right category if mis-sorted.
...
- #9732 `c322fa4` [Trivial] Remove nonsense #undef foreach (jnewbery)
...
- #9930 `9c94fb6` Trivial: Correct indentation and bracing (matthias-g)
...
- #10008 `d42729a` [trivial] Fix a typo (introduced two days ago) in the default fee warning (practicalswift)
...
- #9960 `c71f0ca` Trivial: Add const modifier to GetHDChain and IsHDEnabled (NicolasDorier)
...
- #9936 `8bfa13b` [trivial] Fix three typos introduced into walletdb.h in commit 7184e25 (practicalswift)
...
- #10002 `ad44438` fix gitian doc example script typo (greenaddress)
- #9995 `8bcf934` [doc] clarify blockchain size and pruning (askmike)
- #10033 `10b930d` Trivial: Fix typo in key.h comment (bitstein)
- #9734 `0c17afc` Add updating of chainTxData to release process (sipa)
- #10045 `90586b6` [trivial] Fix typos in comments (practicalswift)
...
- #10167 `813eacf` [trivial] Fix typo ("improssible" → "impossible") (practicalswift)
...
- #10258 `ed22eb4` Fixed typo in documentation for merkleblock.h (Mikerah)
...
- #10180 `e7b90f7` [trivial] Fix typos (tempoarily → temporarily, inadvertantly → inadvertently) (practicalswift)
...
- #10432 `993a1d7` [Trivial] Add BITCOIN_FS_H endif footer in fs.h (plaxton)
- #10372 `15254e9` Add perf counter data to GetStrongRandBytes state in scheduler (TheBlueMatt)
- #10419 `b40ceed` [trivial] Fix three recently introduced typos (practicalswift)
- #10461 `55b72f3` Update style guide (sipa)
- #10479 `5dd69ce` [trivial] Fix comment for ForceSetArg() (jnewbery)
...
- #10469 `b6b150b` Fixing typo in rpcdump.cpp (keystrike)
...
- #10538 `3275180` [trivial] Fix typo: "occurrences" (misspelled as "occurrances") (practicalswift)
...
- #10633 `6bef7ca` doc: Fix various typos (dimitris-t)
...
- #9544 `f3f1e2e` [trivial] Add end of namespace comments. Improve consistency (practicalswift)
- #10688 `080ec52` contrib: Update laanwj key (laanwj)
